...
export const projectsData: Project[] = [
    {
        ...
        description:
            'I built this app to solve the problem of ranking items in a list subjectively. Using the Elo rating system, users can easily compare two items at a time to generate a dynamically updated, ranked list. Rank different types of items: restaurants, movies, shows, books, and albums.',
        features: [
